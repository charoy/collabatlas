...
This backlog captures the main remaining work for the site after the first round of dynamic improvements to the "Find Your Method" wizard.
...
### Still open
- Global search is not yet available.
...
- Some documentation still describes features that are only partially implemented.
...
1. Global search
2. Better catalogue filters
3. Wizard scoring improvements
4. Entry comparison
5. Freshness indicators
6. External metadata enrichment
7. Visual exploration components
