---
title: "PILOT and the Challenge of Long-Term Collaboration Repositories"
summary: "How a French national research project is tackling the sustainability, governance, and adoption challenges that plague collaborative platforms over time."
date: 2026-02-19
...
What sets PILOT apart is its methodological grounding. The project draws on [Practice-Based Computing]({{< relref "/catalogue/frameworks/practice-based-computing" >}}) — a framework developed at the University of Siegen that insists design decisions be rooted in empirical observation of actual work practices. This means ethnographic fieldwork comes before system architecture, and sensitizing concepts guide design rather than prescriptive models.

This approach connects naturally to the broader [CSCW]({{< relref "/catalogue/frameworks/cscw-framework" >}}) and [Socio-Technical Systems]({{< relref "/catalogue/frameworks/socio-technical-systems" >}}) traditions already represented in CollabAtlas.
...
- **Sustainability**: The project envisions the repository as a portal rather than a monolith — pointing to established platforms like [Recherche Data Gouv]({{< relref "/catalogue/datasets/recherche-data-gouv" >}}) for data, HAL for publications, and Software Heritage for code.
