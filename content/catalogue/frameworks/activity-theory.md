...
tagline: "A conceptual framework for analyzing human activities as socially situated, tool-mediated, and goal-directed systems."
data_id: "activity-theory"
domains: ["education", "software-engineering", "social-sciences", "healthcare"]
collaboration-types: ["co-production", "interdisciplinary", "community-based"]
...
Activity Theory is a well-documented framework with extensive evidence, guides, and community support. Key concepts include Activity system, Mediation, Zone of proximal development, Contradictions.
